            ...
            <div className="row">
                <div className="product-cart">
                    <div className="col-md-4 text-center">
                        ...
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMvshvs4e4o4rSJHoHKhjADHAnRoD-iC-0vA&s" alt="" />
                        </div>
                         
                    </div>
                    <div className="col-md-4 text-center">
                        <div className="rate-cart1">
                        <h2>Black Grape</h2>
                        <h4>$4.99-$10.99/kg</h4>
                        <div className="count">
                    ...
                    <div className="col-md-4 text-center">
                       <div className="rate-cart2 text-center">
                       <h3>$4.99-$10.99</h3>
                       </div>
                    </div>
                </div>
